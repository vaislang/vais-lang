...
| 16 | Runtime Pipeline & Compiler Gap Closure | ⏸ In Progress | 6/17 (A1-old/A2/A2.5/A3-old/A5/A8 + 체계적 Phase A1 완료) |
...
> iteration: 6
> max_iterations: 30
>   strategy: vais-codegen crate 공유 + 체계적 설계 변경 → sequential. 시작: A1 (ROI 최대, 기반 작업)
...
- [ ] Phase A3. TC Span-based Type Lookup 확립
- [ ] Phase A2. Match/If-else Two-pass 구조 재구조화 [blockedBy: A1 ✓]
- [ ] Phase B2. PHI Predecessor Mismatch 최종 해결 [blockedBy: A2]
- [ ] Phase B1. Array → Slice Coercion (length metadata)
- [ ] Phase B3. %suffix Cross-module Name Collision [blockedBy: A1 ✓]
