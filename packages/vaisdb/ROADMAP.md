...
> iteration: 14
> max_iterations: 30
>   strategy: sequential. A1/A3/A2/B2/B1/B3/B4 ✓ + bonus: str↔i64, int→float sitofp, outer-if double-phi widening, Vec→&[T] fat pointer. 링크 에러 3 → 2 (F64 enum payload pattern-binding bug + Row.decode PHI predecessor mismatch). C1/C2/C3 이전 남은 cascade 범위 커 **user judgment 필요**
